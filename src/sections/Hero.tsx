  ...
  return (
    <section className={`hero-container fade-in-section ${isVisible ? 'is-visible' : ''}`} aria-labelledby="hero-heading">
      ...
      >
        ...
        >
          I&apos;m a <span className="highlight">Software Engineer & Full-Stack Developer</span> specializing in <span className="highlight">real-time </span> systems, 
          modern UI/UX workflows, and I mostly work with <span className="highlight">Javascript</span>. My expertise includes <span className="highlight">AWS</span>, <span className="highlight">Node</span>, <span className="highlight">Docker</span>, <span className="highlight">Sockets</span>, 
          and WebRTC.
        </motion.p>
        <motion.div
        ...
        >
          <Button
            ...
            link="https://www.linkedin.com/in/nikhil-sharma-1aa669294/"
            aria-label="LinkedIn profile of Nikhil Sharma"
            variant="primary"
            size="lg"
